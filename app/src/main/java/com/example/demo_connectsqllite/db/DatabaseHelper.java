package com.example.demo_connectsqllite.db;
...
import com.example.demo_connectsqllite.db.entity.Contact;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public long insertContact(String name, String email){
        ...
        long newRowId = db.insert(Contact.TABLE_NAME, null, values);
        return newRowId;
    }
    public int updateContact (Contact contact){
        ...
        int rowUpdated = db.update (Contact. TABLE_NAME, values, Contact. COLUMN_ID+"=?",
